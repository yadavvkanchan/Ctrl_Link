      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li>
              <Link href="/">
                <a className="hover:text-indigo-400 transition">Home</a>
              </Link>
            </li>
            <li>
              <Link href="/features">
            ...
            <li>
              <Link href="/pricing">
                <a className="hover:text-indigo-400 transition">Pricing</a>
              </Link>
            </li>
            <li>
              <Link href="/about">
            ...
            <li>
              <Link href="/login">
                <a className="hover:text-indigo-400 transition">Login</a>
              </Link>
            </li>
          </ul>
        </div>
